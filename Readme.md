...
Aperçu
<img src="https://circafrax.github.io/beta-test/screenshot.png" width="650">
À gauche tu remplis, à droite tu as le .md prêt pour GitHub – 100% offline

Philosophie : Un rapport = Un fichier
Comme tes autres Codex : 1 outil = 1 fichier. Tu le mets dans ton repo, ton testeur clique, il te rend un fichier carré.
